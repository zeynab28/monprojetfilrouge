 ...
 */
final class Version20190904115353 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE transaction ADD nom VARCHAR(255) NOT NULL, ADD prenom VARCHAR(255) NOT NULL, ADD telephone VARCHAR(255) NOT NULL, DROP user_id, DROP expediteur_id, DROP beneficiaire_id');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE transaction ADD user_id INT DEFAULT NULL, ADD expediteur_id INT DEFAULT NULL, ADD beneficiaire_id INT DEFAULT NULL, DROP nom, DROP prenom, DROP telephone');
