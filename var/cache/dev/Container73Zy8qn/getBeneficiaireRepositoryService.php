...
// Returns the private 'App\Repository\BeneficiaireRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/BeneficiaireRepository.php';

return $this->privates['App\\Repository\\BeneficiaireRepository'] = new \App\Repository\BeneficiaireRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
