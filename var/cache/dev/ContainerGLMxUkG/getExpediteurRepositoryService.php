...
// Returns the private 'App\Repository\ExpediteurRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/ExpediteurRepository.php';

return $this->privates['App\\Repository\\ExpediteurRepository'] = new \App\Repository\ExpediteurRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
