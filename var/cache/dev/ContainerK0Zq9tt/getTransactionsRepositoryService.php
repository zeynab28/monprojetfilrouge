...
// Returns the private 'App\Repository\TransactionsRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/TransactionsRepository.php';

return $this->privates['App\\Repository\\TransactionsRepository'] = new \App\Repository\TransactionsRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
