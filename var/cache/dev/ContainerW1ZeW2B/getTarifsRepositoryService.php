...
// Returns the private 'App\Repository\TarifsRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/TarifsRepository.php';

return $this->privates['App\\Repository\\TarifsRepository'] = new \App\Repository\TarifsRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
