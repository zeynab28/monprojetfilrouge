...
return [
    ...
    [ // $staticRoutes
        ...
        '/api/envoi' => [[['_route' => 'transaction_new', '_controller' => 'App\\Controller\\TransactionController::envoi'], null, ['GET' => 0, 'POST' => 1], null, false, false, null]],
    ...
    [ // $dynamicRoutes
        ...
        203 => [[['_route' => 'status', '_controller' => 'App\\Controller\\UserController::status'], ['id'], ['PUT' => 0], null, false, true, null]],
