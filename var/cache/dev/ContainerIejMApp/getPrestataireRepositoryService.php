...
// Returns the private 'App\Repository\PrestataireRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/PrestataireRepository.php';

return $this->privates['App\\Repository\\PrestataireRepository'] = new \App\Repository\PrestataireRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
