...
class __TwigTemplate_0fa73eebfd07c19404cef845abaefa5271d8f7dc037a6cd62701c8ee9dc1bc5f extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    <table class=\"table\">
        ...
        echo "</td>
            ...
            <tr>
                ...
                <td>";
        // line 16
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["compte"]) || array_key_exists("compte", $context) ? $context["compte"] : (function () { throw new RuntimeError('Variable "compte" does not exist.', 16, $this->source); })()), "numbcompte", [], "any", false, false, false, 16), "html", null, true);
        echo "</td>
            </tr>
            <tr>
                <th>Solde</th>
...
{% endblock %}
", "compte/show.html.twig", "/home/seynabou/Documents/symfony-api/monprojetfilrouge/templates/compte/show.html.twig");
    }
}
