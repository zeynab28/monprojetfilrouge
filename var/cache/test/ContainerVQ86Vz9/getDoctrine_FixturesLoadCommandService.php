...
$this->privates['doctrine.fixtures_load_command'] = $instance = new \Doctrine\Bundle\FixturesBundle\Command\LoadDataFixturesDoctrineCommand(($this->privates['doctrine.fixtures.loader'] ?? $this->load('getDoctrine_Fixtures_LoaderService.php')), ($this->services['doctrine'] ?? $this->getDoctrineService()));
