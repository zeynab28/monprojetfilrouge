...
return $this->privates['App\\DataFixtures\\UserFixtures'] = new \App\DataFixtures\UserFixtures(($this->services['security.password_encoder'] ?? $this->load('getSecurity_PasswordEncoderService.php')));
